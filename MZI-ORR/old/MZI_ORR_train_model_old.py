...
result = pd.read_csv("../training_data.csv", header=None)
...
Model = Sequential()
Model.add(Dense(80, input_dim=200))
Model.add((ReLU()))
...
es = EarlyStopping(monitor='val_loss', mode='auto', verbose=1, patience=100000)

### Using levenberg_marquardt algorithm
using_lm = True
if using_lm:
    ...
    history = model_wrapper.fit(x_train, y_train, epochs=5000,
